    ...
    if (enableLiquidGlass && backdrop != null) {
       ...
       Box(
           modifier = Modifier
               ...
               // .layerBackdrop(backdrop) REMOVED to avoid self-capture
               .drawBackdrop(
                   backdrop = backdrop,
           ...
           Row(
               ...
               LiquidButton(
                   ...
                   backdrop = backdrop
                    ...
                    Icon(Icons.Filled.ContentCopy, "Copy", tint = buttonContentColor)
               }
               LiquidButton(
                   onClick = onMoveClick, 
                   enabled = showMove,
                   backdrop = backdrop
                    ...
                    Icon(Icons.AutoMirrored.Filled.DriveFileMove, "Move", tint = buttonContentColor)
               }
               LiquidButton(
                   ...
                   Icon(Icons.Filled.DriveFileRenameOutline, "Rename", tint = buttonContentColor)
               }
               LiquidButton(
                   ...
                   Icon(Icons.AutoMirrored.Filled.PlaylistAdd, "Add to Playlist", tint = buttonContentColor)
               }
               LiquidButton(
        ...
        // Standard Material 3 Implementation
        Surface(
          modifier = Modifier
            .windowInsetsPadding(WindowInsets.systemBars)
            .padding(horizontal = 20.dp, vertical = 8.dp),
